...
func (f *CapacityFactory) CreateCapacity(controlType string, resourceID string) (capacities.Capacity, error) {
	...
	case "AccumulatorReset":
		return cimcapacities.NewAccumulatorResetCapacity(resourceID), nil
	case "Command":
		return cimcapacities.NewCommandCapacity(resourceID), nil
	case "RaiseLowerCommand":
		return cimcapacities.NewRaiseLowerCommandCapacity(resourceID), nil
	case "SetPoint":
		return cimcapacities.NewSetPointCapacity(resourceID), nil
	case "AnalogMeasurement":
		if f.mqConsumer == nil {
			return nil, fmt.Errorf("MQ consumer is required for AnalogMeasurement capacity")
		}
		// 默认测量类型，可以通过额外参数指定
		return cimcapacities.NewAnalogMeasurementCapacity(resourceID, "AnalogMeasurement", f.mqConsumer), nil
	case "AccumulatorMeasurement":
		if f.mqConsumer == nil {
			return nil, fmt.Errorf("MQ consumer is required for AccumulatorMeasurement capacity")
		}
		return cimcapacities.NewAccumulatorMeasurementCapacity(resourceID, "AccumulatorMeasurement", f.mqConsumer), nil
	case "DiscreteMeasurement":
		if f.mqConsumer == nil {
			return nil, fmt.Errorf("MQ consumer is required for DiscreteMeasurement capacity")
		}
		return cimcapacities.NewDiscreteMeasurementCapacity(resourceID, "DiscreteMeasurement", f.mqConsumer), nil
	case "StringMeasurement":
		if f.mqConsumer == nil {
			return nil, fmt.Errorf("MQ consumer is required for StringMeasurement capacity")
		}
		return cimcapacities.NewStringMeasurementCapacity(resourceID, "StringMeasurement", f.mqConsumer), nil
	default:
...
func (f *CapacityFactory) CreateMeasurementCapacity(
	...
	case "AnalogMeasurement":
		return cimcapacities.NewAnalogMeasurementCapacity(measurementID, measurementSubType, f.mqConsumer), nil
	case "AccumulatorMeasurement":
		return cimcapacities.NewAccumulatorMeasurementCapacity(measurementID, measurementSubType, f.mqConsumer), nil
	case "DiscreteMeasurement":
		return cimcapacities.NewDiscreteMeasurementCapacity(measurementID, measurementSubType, f.mqConsumer), nil
	case "StringMeasurement":
		return cimcapacities.NewStringMeasurementCapacity(measurementID, measurementSubType, f.mqConsumer), nil
	default:
